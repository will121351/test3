...
<div class="c-bar margin-top5">
  <span class="c-position"><s:message code="visitStat.management"/> - <s:message code="${oprt=='edit' ? 'edit' : 'create'}"/></span>
</div>
...
<table border="0" cellpadding="0" cellspacing="0" class="in-tb margin-top5">
  <tr>
    <td colspan="4" class="in-opt">
			<shiro:hasPermission name="ext:visit_stat:create">
			...
			<shiro:hasPermission name="ext:visit_stat:copy">
			...
			<shiro:hasPermission name="ext:visit_stat:delete">
  ...
  <tr>
    <td class="in-lab" width="15%"><em class="required">*</em><s:message code="visitStat.name"/>:</td>
    <td class="in-ctt" width="35%"><f:text name="name" value="${oprt=='edit' ? (bean.name) : ''}" class="required" maxlength="100" style="width:180px;"/></td>
    <td class="in-lab" width="15%"><s:message code="visitStat.name"/>:</td>
